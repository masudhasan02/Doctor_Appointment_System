<%-- 
    ...
    Created on : 19 Nov, 2023, 2:46:44 PM
    Author     : kargh
--%>
...
<%
    ...
    if (sesss != null && sesss.getAttribute("adminname") != null) {
        // User is logged in
        String username = (String) sesss.getAttribute("username");
%>
<%--     <%
        } else {
...
<html>
    ...
    <%
        ...
        ops = (OraclePreparedStatement) oconn.prepareCall("select f_name, m_name, l_name, email, phn, gender, username, password, secques, secans from user_details");
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        %>
                        <td><form action="http://localhost:8080/DoctorAppointment/DeleteUser" method="post">
