<%-- 
    Document   : optVerification
    Created on : 22 Nov, 2023, 3:51:23 PM
    Author     : kargh
--%>
...
<%
    ...
    if (sessss != null && sessss.getAttribute("tempname") != null) {
        // User is logged in
        String username = (String) sessss.getAttribute("username");
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form id="otpForm" action="http://localhost:8080/DoctorAppointment/OtpVerification" method="post">
