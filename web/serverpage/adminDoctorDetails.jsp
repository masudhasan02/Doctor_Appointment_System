<%-- 
    ...
    Created on : 19 Nov, 2023, 6:23:36 PM
    Author     : kargh
--%>
...
<html>
    ...
    <%
        ...
        ops = (OraclePreparedStatement) oconn.prepareCall("select name, specialization, practicing_hospital, years_of_experience, email, sunday,monday, tuesday, wednesday,thursday, friday, saturday, timing from doctor_details");
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Email</th>
                        <th>Sunday's Chamber</th>
                        <th>Monday's Chamber</th>
                        <th>Tuesday's Chamber</th>
                        <th>Wednesday's Chamber</th>
                        <th>Thursday's Chamber</th>
                        <th>Friday's Chamber</th>
                        <th>Saturday's Chamber</th>
                        <th>Timings</th>
                        <th>Action</th>
                    </tr>
                </thead>
                    ...
                    <tr>
                        <%
                            for (counter = 1; counter <= orsmd.getColumnCount(); counter++) {
                                if (counter == 5) {
                                    email = ors.getString(counter);
                                }
                        %>
                        <td><%=ors.getString(counter)%></td>
                        <%
                            }%>
                        <td><form action="http://localhost:8080/DoctorAppointment/DeleteDoctor" method="post">
                                <input type="hidden" name="doctorEmail" value="<%= email%>">
                                <input type="submit" class="primary-button" value="Delete">
                            </form></td>
                    </tr>
                    <%
                        }
