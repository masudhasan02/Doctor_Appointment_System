 ...
 * @author kargh
 */
public class userUpdatePass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet userUpdatePass</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            if (sess != null && sess.getAttribute("username") != null) {
                ...
                String password = (String) sess.getAttribute("userPassword");

                String passs = request.getParameter("oPass");
                if (password.equals(passs)) {
                    ...
                    if (pass1 != null && pass2 != null && pass1.equals(pass2)) {
                        try {
                            ...
                            sess.invalidate();
                            out.println("<script>alert('Password changed successfully! Please Login again.');</script>");

                        } catch (Exception e) {
                            out.println(e);
                        }
                    } else {
                        out.println("alert('Please type same value for both the new password fields');");
                    }

                } else {
                    out.println("<script>alert('Wrong current password entered');</script>");
                }
            } else {
