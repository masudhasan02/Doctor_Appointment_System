 ...
 * @author kargh
 */
@WebServlet(name = "UserOtpVerification", urlPatterns = {"/UserOtpVerification"})
public class UserOtpVerification extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet userOtpVerification</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            if (sess != null && sess.getAttribute("username") != null) {
                ...
                if (xx.equals(userOtp)) {
                    response.sendRedirect("http://localhost:8080/DoctorAppointment/serverpage/userNewPass.jsp");
                } else {
